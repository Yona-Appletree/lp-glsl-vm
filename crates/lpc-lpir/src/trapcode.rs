...
impl TrapCode {
    ...
    /// A heap access detected an out-of-bounds error.
    ///
    ...
    /// Number of reserved opcodes for LPIR itself. This number of traps are
    ...
    /// Returns a slice of all traps except user-defined traps
...
impl Display for TrapCode {
    fn fmt(&self, f: &mut Formatter) -> fmt::Result {
        let identifier = match *self {
            ...
            TrapCode(x) => return write!(f, "user{}", x.get()),
        };
