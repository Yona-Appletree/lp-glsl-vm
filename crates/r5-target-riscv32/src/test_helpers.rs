...
pub fn debug_ir_with_ram(ir: &str, ram_size: usize) -> Result<Riscv32Emulator, EmulatorError> {
    ...
    Ok(Riscv32Emulator::new(bytes, vec![0; ram_size]).with_log_level(LogLevel::Instructions))
}
