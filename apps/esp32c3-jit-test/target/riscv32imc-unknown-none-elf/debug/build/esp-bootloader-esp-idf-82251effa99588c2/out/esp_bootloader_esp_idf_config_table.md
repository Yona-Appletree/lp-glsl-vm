...
|--------|:---------:|:------------------:|:-------------------:|
| <p>**ESP_BOOTLOADER_ESP_IDF_CONFIG_MMU_PAGE_SIZE**</p> <p>ESP32-C2, ESP32-C6 and ESP32-H2 support configurable page sizes. This is currently only used to populate the app descriptor.</p> | ⚠️ Unstable | 64k | One of: <ul style="display: inline-block; text-align: left"><li>8k</li><li>16k</li><li>32k</li><li>64k</li></ul>
